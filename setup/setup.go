...
func usage() {
	...
	fmt.Printf("\t%s set config instanceurl [url] - Set your instance URL (do this first) \n", common.CommandName)
	fmt.Printf("\t%s setup app - Register an application with Mastodon (do this second)\n", common.CommandName)
	fmt.Printf("\t%s setup creds - Set up user credentials for your account (do this third)\n", common.CommandName)
